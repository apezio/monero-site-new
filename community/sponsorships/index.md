...
<div>
    <section class="container sponsors">
        <div class="row">
            <div class="left one-third no-pad-sm col-lg-4 col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="center one-third no-pad-sm col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="info-block">
                    <div class="row center-xs">
                        <div class="col">
                            <h2>Araxis</h2>
            ...
            <div class="right one-third no-pad-sm col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="info-block">
                    <div class="row center-xs">
                        <div class="col">
